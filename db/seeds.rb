...
subtask1 = Subtask.create(:title => "Subtest 1", :difficulty => 0, :level => 2, :task_id => task.id, :created => Time.now)
subtask2 = Subtask.create(:title => "Subtest 2", :difficulty => 3, :level => 1, :task_id => task.id, :created => Time.now)
